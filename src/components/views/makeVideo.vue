    ...
    <div class="back relative flex h-screen overflow-auto">
        ...
        <div class="mx-auto flex flex-col justify-center px-8">
                    ...
                    <div class="bg-grey flex flex-1 flex-col gap-8 p-6">
                        ...
                        <div class="flex-0 flex items-center">
                            <div class="bg-ptb flex h-12 w-full items-center rounded-lg">
                                <textarea class="bg-ptb mx-4 w-full resize-none text-lg text-black outline-none"
                                    placeholder="输入信息" v-model="chat" :rows="rows"
                                    @keydown.enter.prevent="addBox"></textarea>
                            </div>
            ...
            <div
                ...
                <router-link to="/aiChat"><v-icon name="hi-solid-arrow-right"
                        class="h-7 w-7 text-white" /></router-link>
                <router-link to="/startFun">
