<template>
  <div class="flex flex-1 gap-4 lg:justify-center xl:pl-48 ">
    ...
    <div class="diyborder my-6 flex w-1/2 min-w-96 max-w-128 flex-col rounded-xl bg-[#525e7b]">
      ...
      <div class="mt-6 px-6">
        <div class="relative w-full">
          <label for="input" class="bg-ptb absolute -top-3 left-2 z-20 rounded-md px-1 text-[#7480ff]">Name:</label>
          <input type="text" placeholder="Write here..." name="input"
            class="bg-ptb diyborder w-full rounded-md p-2 text-black outline-none" v-model="img_name" />
        </div>
      </div>
      <!-- begin：生成 -->
    ...
    <div class="diyborder my-6 flex w-1/2 min-w-96 max-w-128 flex-col rounded-xl bg-[#525e7b] p-6">
      <!-- video -->
      <div class="relative">
        <img src="/assets/img/0.jpg" class="diyborder mx-auto aspect-square w-48 rounded-lg" />
        <div
